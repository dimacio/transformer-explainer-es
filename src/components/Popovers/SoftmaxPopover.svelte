...
<Card class={'softmax-popover popover bg-white text-sm'}>
	...
	>
		<h3 class="font-semibold text-gray-900">
			Probabilidad de que el token <span class="highlight">"{selected?.token}"</span> sea elegido
		</h3>
	</div>
		...
		<div class="formula-steps">
			<div class="formula-step scaled">
				<TextbookTooltip id="temperature">
					<div class="step-title">Logit escalado</div></TextbookTooltip
				>
				<div class="step-content">
					<div class="fraction">
						...
						<div class="frac-bottom relative">
							...
							<span class="annotation temp"> <Arrow size={16} /><span>temperatura</span></span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="formula-step sampling">
				<TextbookTooltip id="sampling">
					<div class="step-title">
						<span>Filtrado {$sampling.type === 'top-k' ? 'top-k' : 'top-p'}</span>
							...
							<div class="cases">
								<div class="case-row">
									<span class="condition text"
										>Si el logit <Katex math={'\\in'} /> Top-{$sampling.value}
									</span>
			...
			{:else}
				<div class="formula-step norm-step">
					<div class="step-title">Normalización</div>
					<div class="step-content">
